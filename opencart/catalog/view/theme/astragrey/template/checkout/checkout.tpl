  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="panel-group" id="accordion">
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <h4 class="panel-title">第 2 步：收货地址</h4>
          </div>
          <div class="panel-collapse collapse" id="collapse-payment-address">
            <div class="panel-body"></div>
          </div>
          ...
          <div class="panel panel-default">
              <div class="panel-heading">
                  <h4 class="panel-title">第 3 步：配送方式</h4>
              </div>
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <h4 class="panel-title">第 4 步：支付方式</h4>
          </div>
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <h4 class="panel-title">第 5 步：订单确认</h4>
          </div>
...
$(document).ready(function() {
    $.ajax({
        ...
        success: function(html) {
			...
			$('#collapse-payment-address').parent().find('.panel-heading .panel-title').html('<a href="#collapse-payment-address" data-toggle="collapse" data-parent="#accordion" class="accordion-toggle">第 2 步：收货地址<i class="fa fa-caret-down"></i></a>');
            ...
            if (json['redirect']) {
                ...
                $.ajax({
                    ...
                    success: function(html) {
                        ...
                        $('#collapse-shipping-method').parent().find('.panel-heading .panel-title').html('<a href="#collapse-shipping-method" data-toggle="collapse" data-parent="#accordion" class="accordion-toggle">第 3 步：配送方式<i class="fa fa-caret-down"></i></a>');
            ...
            if (json['redirect']) {
                ...
                $.ajax({
                    ...
                    success: function(html) {
						...
						$('#collapse-payment-method').parent().find('.panel-heading .panel-title').html('<a href="#collapse-payment-method" data-toggle="collapse" data-parent="#accordion" class="accordion-toggle">第 4 步：支付方式 <i class="fa fa-caret-down"></i></a>');
            ...
            if (json['redirect']) {
                ...
                $.ajax({
                    ...
                    success: function(html) {
						...
						$('#collapse-checkout-confirm').parent().find('.panel-heading .panel-title').html('<a href="#collapse-checkout-confirm" data-toggle="collapse" data-parent="#accordion" class="accordion-toggle">第 5 步：订单确认 <i class="fa fa-caret-down"></i></a>');
