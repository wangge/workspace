          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-weight">商品单位</label>
                    <div class="col-sm-10">
                        <select name="units_id" id="units_id" class="form-control">
                            <?php foreach ($units_list as $key=>$unnit) { ?>
                            <?php if ($key == $units_id) { ?>
                            <option value="<?php echo $key; ?>" selected="selected"><?php echo $unnit; ?></option>
                            <?php } else { ?>
                            <option value="<?php echo $key; ?>"><?php echo $unnit; ?></option>
                            <?php } ?>
                            <?php } ?>
                        </select>
                    </div>
