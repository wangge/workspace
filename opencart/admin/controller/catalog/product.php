...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
        ...
        $data['units_list'] = $this->model_localisation_units->getUnitsList();

        if (isset($this->request->post['units_id'])){
            $data['units_id'] = $this->request->post['units_id'];
        } elseif (!empty($product_info)){
            $data['units_id'] = $product_info['units_id'];
        }
